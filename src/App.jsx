      ...
      `}</style>      <div style={{position:"relative",width:GW*sc2,height:GH*sc2,border:meta.showBorder!==false?"1px solid #2a2a3a":"none",zIndex:1}}>
        ...
        {phase==="settings"&&(
          <div style={{position:"absolute",inset:0,display:"flex",flexDirection:"column",background:"#06060e",zIndex:10,overflow:"hidden"}}>
            ...
            <div style={{color:"#334455",fontSize:7,marginTop:6,letterSpacing:1}}>Version 2.1.5</div>
          {showShipPopup&&(
        ...
        {phase==="metashop"&&(
          <div style={{position:"absolute",inset:0,display:"flex",flexDirection:"column",background:"#06060e",zIndex:10,overflow:"hidden"}}>
            ...
            {metaTab==="abilities"&&(()=>{
              ...
              const shardCost=(()=>{let _sc=Math.ceil(100*Math.pow(1+bought*0.12,1.6));if(_sc>400)_sc=Math.ceil(400+(_sc-400)*1.35);if(_sc>1000)_sc=Math.ceil(1000+(_sc-1000)*1.25);return _sc;})();
